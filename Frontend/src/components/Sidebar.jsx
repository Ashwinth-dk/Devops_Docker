...
//     }`}
//     title={!sidebarOpen ? "Payroll Management" : ""}
//   >
//     <i className="fs-5 mx-1 bi-cash-stack"></i>
//     <span
//       className={`ms-2 d-none d-sm-inline ${
//         !sidebarOpen ? "hidden" : ""
//       }`}
    ...
    >
      ...
      >
        ...
        <ul
          ...
          id="menu"
        >
          {/* EMPLOYEES - visible to data_operator & admin */}
          {(role === "data_operator" || role === "admin") && (
            <li className="w-100">
              <Link
                to="/dashboard/employee"
                className={`nav-link text-white ${
          ...
          {/* ADMIN MANAGEMENT - visible to data_operator & admin */}
          {(role === "data_operator" || role === "admin") && (
            <li className="w-100">
              <Link
                to="/dashboard/manageadmin"
          ...
          {/* OTHER LINKS - visible only to admin */}
          {role === "admin" && (
            <>
              <li className="w-100">
                <Link
        ...
        >
          <i className={`fs-5 px-1 bi-power`}></i>
          <span className={`ms-2 d-none d-sm-inline ${!sidebarOpen ? "hidden" : ""}`}>
            Logout
          </span>
        </Button>
